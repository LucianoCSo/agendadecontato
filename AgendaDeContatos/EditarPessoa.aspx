<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditarPessoa.aspx.cs" Inherits="AgendaDeContatos.EditarPessoa" %>
...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
            ...
            <div class="panel-body">
                ...
                <fieldset class="col-md-10">
                    ...
                    <div class="form-row">
                        ...
                        <div>
                            <asp:GridView ID="GridView1" CssClass="table table-hover text-center" runat="server" Width="380" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateDeleteButton="True" OnRowDeleting="GridView1_RowDeleting" OnRowEditing="GridView1_RowEditing" >
    ...
    <asp:Button ID="btnSalvar" CssClass="btn btn-primary" Style="margin-left:15px;" runat="server" Text="Salvar Contato" />
